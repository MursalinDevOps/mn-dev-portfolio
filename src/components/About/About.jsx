...
const About = () => {
    ...
    return (
      ...
      <h2 className="text-4xl font-bold text-base-300 mb-8">About Me</h2>
           <div className="text-white px-6 border border-gray-500 rounded-lg shadow-lg bg-transparent md:py-10">
      <div className="bg-transparent rounded-lg shadow-lg px-2 py-6 md:px-6 max-w-lg mx-auto text-center">
        <img
