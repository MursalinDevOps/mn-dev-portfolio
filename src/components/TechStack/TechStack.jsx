...
const TechStack = () => {
    ...
    return (
        <div className="md:w-11/12 mx-auto">
            ...
            {
                technologies.map((technology,idx)=><div key={idx} className="bg-gray-700 rounded p-4 flex gap-4 items-center text-center transition duration-300 ease-in-out hover:bg-opacity-90 hover:scale-105">
